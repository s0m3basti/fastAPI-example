...
database = client.students # set the databse we are working on

student_collection = database.get_collection("students_collection") # set the tabel / collection

# helpers

# transforms the student from databse into python understanable object
